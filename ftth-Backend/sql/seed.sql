...
('AAHA-0006', 'Manjunath R',    'manjunath@aaha.demo',87000.00,'ACTIVE'),
('AAHA-0007', 'Kiran Narayana', 'kiran@aaha.demo',    75000.00, 'ACTIVE'),
('AAHA-0008', 'Anvitha Reddy',  'anvitha@aaha.demo',  82500.00, 'ACTIVE'),
('AAHA-0009', 'Suresh P',       'suresh@aaha.demo',   96000.00, 'ACTIVE'),
('AAHA-0010', 'Gaurav Goyal',   'gaurav@aaha.demo',   65000.00, 'ACTIVE'),

package com.aaha.ftth.planchange.controller;
...
public class PlanChangeController {
    ...
    public ResponseEntity<Map<String, Object>> startPlanChange(@RequestBody Map<String, Object> request) {
        try {
            ...
            variables.put("newPlanId", createVariable(planId, "Long"));
            ...
            String startUrl = camundaUrl + "/process-definition/key/Process_PlanChange/start";
                    ...
                    if (variablesList != null) {
                        for (Map<String, Object> var : variablesList) {
                            ...
                            if ("success".equals(name) || "message".equals(name) ||
                                    "planValid".equals(name) || "connectionActive".equals(name)) {

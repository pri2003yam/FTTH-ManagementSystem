package com.aaha.ftth.disconnect.controller;
...
public class DisconnectController {
    ...
    public ResponseEntity<Map<String, Object>> startDisconnect(@RequestBody Map<String, Object> request) {
        try {
            ...
            String startUrl = camundaUrl + "/process-definition/key/Process_Disconnect/start";
                ...
                if (historyResponse != null && historyResponse.get("endTime") != null) {
                    ...
                    if (variablesList != null) {
                        for (Map<String, Object> var : variablesList) {
                            ...
                            if ("success".equals(name) || "message".equals(name) || "connectionActive".equals(name)) {
